...
let bulbasaurRareCandies = 11;
let caterpieRareCandies = 6;
let weedleRareCandies = 6;
let totalCandies =
  bulbasaurRareCandies + caterpieRareCandies + weedleRareCandies;
...
console.log(canBattle(100));
//Loops
//You have joined an undeground pokemon leauge. In this league, trainers can use any number of pokemon. Print to the console "Pikachu I choose you" x times where x is the number of pokemon the trainer you are battling has in their party
let numOfPockemon = ["bulbasaur", "caterpie", "weedle"];
for (let i = 0; i < numOfPockemon.length; i++) {
